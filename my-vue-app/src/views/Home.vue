...
const getTableData = async () => {
    const { data: { data } } = await proxy.$api.getTableData()
    tableData.value = data.tableData
}

const getCountData = async () => {
    const { data: { data } } = await proxy.$api.getCountData()
    countData.value = data
}

const getChartData = async () => {
    const { data: { data: { orderData, videoData, userData } } } = await proxy.$api.getChartData()
